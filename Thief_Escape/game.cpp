...
bool game::initGraphic()
{
	...
	else
	{
		...
		gWindow = SDL_CreateWindow( "Thief Escape", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_SHOWN );
...
{
	LTexture image;
	image.Load("res/image/thief_back.png", 1);
	image.Render(0, 0);
	image.free();
}
